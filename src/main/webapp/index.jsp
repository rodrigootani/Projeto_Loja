...
<font align="center" color="red">
		...
		<a href="comprarps4.jsp"><img src="Imagens/PS4.jpg"
		onMouseOver="this.src='Imagens/PS42.jpg'"
		...
		<div id="imagem1">
		<font align="center" color="red">
	<a href="comprarxbox.jsp"><img src="Imagens/xboxone.jpg"
		onMouseOver="this.src='Imagens/xbox2.jpg'"
		onMouseOut="this.src='Imagens/xboxone.jpg'" width="500" height="300"></img></a> 
...
<p>			sem juros</p>
	...
	<br/>
		...
		<div id="imagem2">
		<font align="center" color="red">
		<a href="comprarps3.jsp"><img src="Imagens/PS3.png"
		onMouseOver="this.src='Imagens/PS32.jpg'"
...
<p>			sem juros</p></font>
		...
		<a href="Comprarwii.jsp"><img src="Imagens/Nintendo.jpg"
		onMouseOver="this.src='Imagens/wii2.jpg'"
		onMouseOut="this.src='Imagens/Nintendo.jpg'" width="500" height="300"></img></a> 
		<p>Valor:R$489,90</p>
				<p>12x R$48,83<p>
<p>sem juros	</p>	
		</font>
